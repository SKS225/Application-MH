...
class ImagePermissionTextProvider: PermissionTextProvider {
    override fun getDescription(isPermanentlyDeclined: Boolean): String {
        return if(isPermanentlyDeclined) {
            ...
            "This app needs access to your photos so that you can view them here."
        }
    }
}
...
class AudioPermissionTextProvider: PermissionTextProvider {
    override fun getDescription(isPermanentlyDeclined: Boolean): String {
        return if(isPermanentlyDeclined) {
            ...
            "This app needs access to your audios so that you can listen them here."
        }
    }
}
...
class VideoPermissionTextProvider: PermissionTextProvider {
    override fun getDescription(isPermanentlyDeclined: Boolean): String {
        return if(isPermanentlyDeclined) {
            "It seems you permanently declined videos permission."+
                    "You can go to the app settings to grant it."
        } else {
            "This app needs access to your videos so that you can play them here."
        }
    }
}